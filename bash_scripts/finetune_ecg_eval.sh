...
# downstream_task="classification"
# nb_classes="2"
# data_path=$data_base"/ecg/ecgs_train_CAD_tenth_balanced_noBase_gn.pt"
# labels_path=$data_base"/ecg/labelsOneHot/labels_train_CAD_tenth_balanced.pt"
# downstream_task="classification"
# nb_classes="2"
...
output_dir=$checkpoint_base"/sprai/mae_he/mae/output/fin/"$folder"/"$subfolder"/fin_b"$(($batch_size*$accum_iter))"_blr"$blr"_"$pre_data
...
resume=$checkpoint_base"/sprai/mae_he/mae/output/fin/"$folder"/"$subfolder"/fin_b"$(($batch_size*$accum_iter))"_blr"$blr"_"$pre_data"/checkpoint-25-pcc-0.38.pth"
