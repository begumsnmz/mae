                ...
                do 
                    ...
                    do
                        ...
                        do
                            ...
                            # finetune=$checkpoint_base"/sprai/mae_he/mae/output/pre/ecg/ncc_weight0.3/seed0/tiny/t2500/p1x100/wd0.15/m0.8/pre_b128_blr1e-5/checkpoint-399-ncc-0.96.pth"
                            finetune=$checkpoint_base"/ECGMultimodalContrastiveLearning/oezguen/checkpoints/ecg/ecg_v100_mae_checkpoint.pth"
