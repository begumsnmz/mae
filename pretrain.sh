...
transfer_data_path="/home/oturgut/PyTorchEEG/data/preprocessed/data_SEED_fs200.pt"
...
do
    ...
    do
        if [ "$external" = "on" ]; then
            ...
            subfolder="dinh/0.6train/1d/minmax"
            ...
            subfolder="test_changes" #/dinh/0.6train/decomposed/huge"
            output_dir="./output/pre/"$folder"/"$subfolder"/"$pre_data
            log_dir="./logs/pre/"$folder"/"$subfolder"/"$pre_data
