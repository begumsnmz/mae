...
data_path="/home/oturgut/PyTorchEEG/data/preprocessed_2/old/data_DINH_10fold_decomposed_ideal_fs200.pt"
labels_path="/home/oturgut/PyTorchEEG/data/preprocessed_2/old/labels_2classes_DINH_10fold_fs200.pt"
nb_classes="2"
...
do
    ...
    if [ "$eval" = "False" ]; then
        ...
        resume="/home/oturgut/PyTorchEEG/mae_he/mae/output/fin/"$folder"/"$subfolder"/dinh2_fin_b"$batch_size"_blr"$blr"_"$pre_data"/checkpoint-49.pth"
